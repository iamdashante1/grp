...
const EN: Messages = {
  ...
  "contact.title": "Support Center",
  "contact.subtitle": "Need help with BloodBridge? Our support team is here 24/7. Submit a ticket or reach us through the channels below.",
  "contact.formTitle": "Submit a Support Request",
  "contact.formSubtitle": "Share the details of your issue or question and we'll respond as quickly as possible.",
  "contact.loginRequiredTitle": "Please sign in to submit a support ticket",
  "contact.loginRequiredDescription": "Sign in to your BloodBridge account to access personalized support, track previous tickets, and get status updates.",
  "contact.loginButton": "Sign In",
  "contact.registerButton": "Create Account",
  "contact.guestTitle": "Need more help?",
  "contact.guestDescription": "Create an account or sign in to unlock faster support, see your previous tickets, and access personalized donor tools.",
  "contact.getInTouch": "Other Ways to Reach Us",
  "contact.departments": "Specialized Teams",
  ...
  "contact.quickActions.title": "Quick Support Actions",
  "contact.quickActions.description": "Jump back into the areas where you can take action immediately.",
  "contact.quickActions.dashboard": "Go to Dashboard",
  "contact.quickActions.dashboardDesc": "See your latest alerts and activity",
  "contact.quickActions.profile": "Update Profile",
  "contact.quickActions.profileDesc": "Refresh your personal or medical info",
  "contact.quickActions.requests": "Manage Requests",
  "contact.quickActions.requestsDesc": "Submit or track blood requests",
  "contact.quickActions.support": "Track Support",
  "contact.quickActions.supportDesc": "Review your support conversations",
  "contact.historyTitle": "Recent Support Tickets",
  "contact.historyEmpty": "You haven't submitted any support requests yet.",
  "contact.historyReference": "Reference ID: {reference}",
  "contact.historySubmitted": "Submitted",
  ...
  "request.toast.failed": "Failed to submit blood request. Please try again.",
  ...
  "request.errors.contactEmailRequired": "Contact email is required",
  "request.errors.contactEmailInvalid": "Please enter a valid contact email",
  "request.errors.requiredBy": "Please provide the date blood is needed",
  "request.form.contactEmail": "Contact Email",
  "request.form.requiredBy": "Needed By",
  "request.form.reasonLabel": "Reason for Request",
  "request.form.reasonPlaceholder": "Select a reason",
  "request.form.customHospitalLabel": "Hospital Name",
  "request.form.customHospitalPlaceholder": "Enter hospital name",
  "request.form.summaryTitle": "Request Overview",
  "request.form.summaryVolume": "{units} unit(s) ≈ {volume}ml required",
  "request.form.summaryUrgency": "Urgency: {urgency}",
  "request.form.summaryDeadline": "Needed by {date}",
